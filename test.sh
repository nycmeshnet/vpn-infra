...
ansible-playbook tests.yaml --extra-vars 'env_file=wireguard_sn3.yaml expected_range=["10.70.249.0/24","10.70.250.0/24"] expected_default=["10.70.249.1","10.70.250.1"]'
